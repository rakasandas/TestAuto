...
public class TestDataLoader {
	...
	/* To debug: Activate and use Run As > Java Application  
	 public static void main(String[] args) {
	 println "asdf"
	 Map test = loadLocalizationFile("MASTER", "./Data Files/Resources/Everest Copywriting.xlsx")
	 println "done"
	 println "load key:" + test['content']['id']['commonInputEpinTitleDescriptionLabel'] + ":end load key"
	 }
	 */
